...
<div class="modal fade" id="edit_{{$bootcamp->id}}" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form enctype="multipart/form-data" action="{{route('programme.bootcamp.update',[$bootcamp->id])}}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <option value="{{$bootcamp->application}}">Application {{ucwords($bootcamp->application)}}</option>
                       
                            @if($bootcamp->application == 'close')
